...
#CONTROLLER STABALIZES AFTER 8TH TRIAL
# array of theta and time stamps prints at 8th trial
...
class InvertedPendulumGame(object):
    ...
    def game_round(self):
        ...
        if self.game_round_number == 8:
            print(theta_diff_list)
            print(timestep_list)
            print((len(theta_diff_list)))
            values = self.RL_controller.V_values
